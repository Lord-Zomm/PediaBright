...
const posts = [
  { id: 15, image: '/images/post_15.png', fullImage: '/images/post_15_full.png', caption: 'One of PediaBright’s missions is to improve health literacy in the pediatric population. Stories have the power to do this and bridge communication...' },
  { id: 14, image: '/images/post_14.png', fullImage: '/images/post_14_full.png', caption: 'It is extremely important for kids living with CKD and special kidneys to focus on their diet to make sure they are doing their part to help their kidneys back for all they do. Book 3 of...' },
  { id: 13, image: '/images/post_13.png', fullImage: '/images/post_13_full.png', caption: 'TEAM MEMBER SPOTLIGHT: Nawal Cheema Nawal is the chief technology officer of Pediabright and co-illustrator of our first trilogy on chronic kidney disease. She also joined the team at...' },
  { id: 12, image: '/images/post_12.png', fullImage: '/images/post_12_full.png', caption: 'If you haven’t already, make sure to check out our CKD series on our Amazon Storefront and give us a follow right here on Instagram and our LinkedIn. And while you’re at it, why not...' },
  { id: 11, image: '/images/post_11.png', fullImage: '/images/post_11_full.png', caption: 'Book 3 of the CKD series follows Andrew through a day at school and also introduces a new friend, Riah! Click the link in the bio to reach our Amazon storefront!' },
  { id: 10, image: '/images/post_10.png', fullImage: '/images/post_10_full.png', caption: 'TEAM MEMBER SPOTLIGHT: Aakash Nagarapu Aakash Nagarapu is the chief scientific officer of PediaBright and collects the research and clinical science...' },
  { id: 9, image: '/images/post_9.png', fullImage: '/images/post_9_full.png', caption: 'Book 2 of the CKD series focuses on the care team that a child with CKD might interact with on a day-to-day basis. Meet nephrologists, nurses, phlebotomists, an...' },
  { id: 8, image: '/images/post_8.png', fullImage: '/images/post_8_full.png', caption: 'TEAM MEMBER SPOTLIGHT: Lexi Kayser Lexi Kayser is the chief creative officer of PediaBright and author of our first trilogy on chronic kidney disease. She met the rest o...' },
  { id: 7, image: '/images/post_7.png', fullImage: '/images/post_7_full.png', caption: 'PediaBright was founded with a vision in mind to bridge communication gaps in pediatric healthcare between physicians, patients, and of course, kids! Help...' },
  { id: 6, image: '/images/post_6.png', fullImage: '/images/post_6_full.png', caption: 'They’re finally here! All three books are up for sale in print and E-book on Amazon! Click the link in our bio to go directly to our Amazon Storefront...' },
